...
router.register('chuables/auth', AuthApiListView)
...
urlpatterns = [
    path('chuables/', auth_urls),
    path('chuables/users/', users_urls),
    path('chuables/docs/', doc_urls),
    path('chuables/schema/', schema_view),
    path('chuables/browser/', api_browser_urls),
    path('chuables/admin/', admin.site.urls),
